...
# # 讀取 A.csv 和 B.csv
# a_csv_path = 'total_data_nosplittime.csv'  # A.csv 檔案路徑
# b_csv_path = 'expanded_temperature_data_fixed_time.csv'  # B.csv 檔案路徑
# output_csv_path = 'B_with_temp_and_more.csv'  # 輸出的 CSV 檔案路徑
...
b_csv_path = 'expanded_temperature_data_fixed_time.csv'  # B.csv 檔案路徑
output_csv_path = 'upload_features_temp_windspeed_precp_sunshine.csv'  # 輸出的 CSV 檔案路徑
